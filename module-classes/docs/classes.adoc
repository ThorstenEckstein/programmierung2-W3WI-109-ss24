...
[ <<classes-theory,Theorie>> | <<classes-demo,Demo>> | <<classes-exercise,Übungen>> ]
...
Eine Java Klasse hat grundsätzlich die folgende Signatur, inkl. Eigenschaften (Feldern) und Verhaltensweisen (Methoden):
...
*Demo*:
 ...
 src/test/java/de/dhbw/ClassesDemoTest.java
