...
====
IMPORTANT: Einschub: Zur *Theorie* des -> <<tdd,Test Driven Developments>>, dann wieder hierher zurück!
====
...
====
IMPORTANT: Einschub: "Der Objektvertrag" -> ggf. Referenz auf `module-object-contract`
====
//include::../../module-object-contract/docs/object-contract.adoc[]
...
[plantuml, "overrides", png, float="left", width="100%"]
....
