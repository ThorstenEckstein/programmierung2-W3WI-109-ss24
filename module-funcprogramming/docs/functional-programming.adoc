...
----
include::{module-tests}/LambdaTests.java[tag="lambda-example-1"]
----
...
_? Welchen Datentyp geben die Predicates zurück ?_
...
----
include::{module-tests}/StreamingTests.java[tag="reduce-example1"]
----
...
----
include::{module-tests}/LambdaTests.java[tag="lambda-example-2"]
----
...
[subs="normal"]
 {module-demo-path-tests}/LambdaTests.java & StreamingTests.java
