...
Ein Beispiel::
_Jede natürliche Person besitzt (genau) einen Personalausweis, der Ausweis kann verloren gehen, die Person kann sterben, dann müsste aber auch der Personalausweis vernichtet werden._
