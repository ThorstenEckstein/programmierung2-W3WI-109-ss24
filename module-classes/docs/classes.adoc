...
[subs=normal]
 -> {module-ref-tests}/exercise/classes/ClassesExerciseTest.java
...
[subs=normal]
 -> {module-ref-tests}/demo/tdd/TddDemoTest.java
...
[subs=normal]
 -> {module-ref-tests}/demo/inheritance/InheritanceDemoTest.java
...
[subs=normal]
 -> {module-ref-tests}/exercise/inheritance/InheritanceExerciseTest.java
